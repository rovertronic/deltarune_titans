...
if (text_open) {
	...
	draw_text_transformed(64+camera_get_view_x(view_camera),textbox_y_offset+5+camera_get_view_y(view_camera),text_display,.75,.75,0);
	}

if (menu_open) {
	draw_sprite_ext(spr_StatMenu,menu_state,camera_get_view_x(view_camera),camera_get_view_y(view_camera)-10,0.75,0.75,0,c_white,1)	
